...
# color2 = [[15,60],[121,190],[50,100],"green"]
# color3 = [[180,255],[20,80],[53,101],"pink"]
# color4 = [[200,255],[195,255],[60,80],"yellow"]
...
#            print(f' no {colors[c][3]} points color is not good enough', frame_files[i])
...
#            tolorance = 50 # ± 25 x, y values that it considers near the previous pixel
...
#                print(f' no {colors[c][3]} points in interval try chanceing tolorance', frame_files[i])
#                badFrames.append(i)
#                pointColor.append(PointCordanitesArr[c][i-1][1])
#                pointColor.append(PointCordanitesArr[c][i-1][2])
#            elif theresPoint > 1:
...
VIDEO = "Test1.mp4" # Make sure this matches your video filename
